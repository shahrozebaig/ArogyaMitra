import { Dumbbell, Utensils, Sprout, ArrowRight } from "lucide-react";
        ...
        <div className="db-grid">
          <div className="db-card db-steps-card">
            ...
            <Link to="/health" className="db-assessment-btn">
              Complete Health Assessment <ArrowRight size={18} />
            </Link>
          ...
          <div className="db-card db-focus-card">
            ...
            {loading ? (
              ...
              <div className="db-empty">
                <div className="db-empty-icon"><Sprout size={48} /></div>
